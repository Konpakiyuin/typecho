...
<?php echo date('Y'); ?> © <a target="_blank" href="http://typecho.org/" rel="external nofollow">Typecho</a> Theme <a target="_blank" href="http://fanctsticworld.lu.mk/" rel="external nofollow">Youmu</a> 
</div></div></div>
</div></div>
</div>
...
<?php $this->footer(); ?>
<script src="https://myhkw.cn/api/player/161474092333" id="myhk" key="161474092333" m="1"></script>
</body></html>